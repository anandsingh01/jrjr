            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        @if(Auth::check())
                            <form method="post" action="{{ url('users/edit-fundraiser') }}" class="steps" accept-charset="UTF-8" enctype="multipart/form-data" novalidate="">
                                @csrf
                                <ul id="progressbar">
                                ...
                                <fieldset>
                                    ...
                                    @include('inc.cause-edit.basic_info')
                                ...
                                <fieldset>
                                    ...
                                    @include('inc.cause-edit.document')
                                ...
                                <fieldset>
                                    ...
                                    @include('inc.cause-edit.patientDetails')
                                ...
                                <fieldset>
                                    ...
                                    @include('inc.cause-edit.details')
...
@section('js')
    ...
    <script>
        $(".hs_total_number_of_donors_in_year_2_Setp2 ").on("click", ".deletefiles", function (e) {
        // $('.deletefiles').on('click', function(e){
            ...
            if(confirm('Are you sure you want to delete this attachment?')) {
                $.ajax({
                    url:  "{{url('deleteFromGallery')}}",
                    type: "GET",
                    data: {'imageid':imageid,},
                    success: function(data) {
                        setTimeout(function() {
                            // toastr["success"]('Attachment has been deleted.', 'Success');
                            $('#webform-component-acquisition--amount-3').load(location.href + ' #webform-component-acquisition--amount-3');
                        },500);
                    }
                });
            }
