            ...
            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
                ...
                <tbody class="fw-bold text-gray-600">
                    ...
                    <tr>
                        ...
                        <td>{{ $event->desc ?? 'N/A' }}</td>
                        {{-- <td>{{ $event->donate ?? 'N/A' }}</td> --}}
                        <td>
                            <form action="{{ route('admin-events-delete', ['token' => encrypt($event->id)]) }}"
                                method="POST">
                                <a href="{{ route('admin-events-edit', ['token' => encrypt($event->id)]) }}"
