    ...
    <section>
        <div class="gap nogap">
            <div id="layerslider-container-fw">
                <div id="layerslider" style="width: 100%;  margin: 0 auto; ">

                    @if(!empty($sliders))
                        @foreach($sliders as $slider)
                            <div class="ls-slide" data-ls="transition2d:40; timeshift:-2000;">
                                <img src="{{asset($slider->image)}}" class="ls-bg" alt="Slide background" />
                    ...
                    <div class="col-sm-4">
                        <div class="services">
                            ...
                            <div class="services-meta">
                                <h2>Make Donetion</h2>
                                <p>Help today because tomorrow you may be the one who needs help!</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-4">
                                ...
                                <ul class="nav nav-tabs testi-admin">
                                    <li>
                                        <a href="#admin-1" aria-controls="admin-1" data-toggle="tab">
                                            <img src="dist/images/resources/testimonial-admin-1.jpg" alt="">
                                        </a>
                                        <span>Chirag Kothari</span>
                                    </li>
                                    <li class="active">
                                        <a href="#admin-2" aria-controls="admin-2" data-toggle="tab">
                                            <img src="dist/images/resources/testimonial-admin-2.jpg" alt="">
                                        </a>
                                        <span>Brain Lara</span>
                                    </li>
                                    <li>
                                        <a href="#admin-3" aria-controls="admin-3" data-toggle="tab">
                                            <img src="dist/images/resources/testimonial-admin-3.jpg" alt="">
                                        </a>
                                        <span>Doxis Yoe</span>
                                    </li>
                                </ul>
