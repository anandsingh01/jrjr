...
<head>
    <title>JRJR - User Panel</title>
    <meta charset="utf-8" />
    <meta name="description"
        content="The most advanced Bootstrap Admin Theme on Themeforest trusted by 94,000 beginners and professionals. Multi-demo, Dark Mode, RTL support and complete React, Angular, Vue &amp; Laravel versions. Grab your copy now and get life-time updates for free." />
    <meta name="keywords"
        content="JRJR User Panel" />
    <meta name="viewport" content="width=device-width, initial-scale=1" />
    <meta property="og:locale" content="en_US" />
    <meta property="og:type" content="article" />
    <meta property="og:title"
        content="JRJR - User Panel" />
    <meta property="og:url" content="JRJR" />
    <meta property="og:site_name" content="JRJR" />
    <link rel="canonical" href="https://preview.keenthemes.com/metronic8" />
    <link rel="shortcut icon" href="{{ asset('assets/images/jrjr-logos/jrjr_logo_favicon.png') }}" />
    <!--begin::Fonts-->
        ...
        <div class="page d-flex flex-row flex-column-fluid">
            ...
            <div id="kt_aside" class="aside aside-dark aside-hoverable" data-kt-drawer="true"
                ...
                <div class="aside-logo flex-column-auto" id="kt_aside_logo">
                    ...
                    <img alt="Logo" src="{{ asset('assets/images/jrjr-logos/jrjr_logo.png') }}" class="h-50px logo" />
                    </a>
                    <!--end::Logo-->
                    <!--begin::Aside toggler-->
...
{{--                        <div class="menu menu-column menu-title-white-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"--}}
{{--                            id="kt_aside_menu" data-kt-menu="true">--}}

                            <div class="" id="kt_aside_menu" data-kt-menu="true">
                            @if(Auth::check())
                                @if(Auth::user()->role == 1)
                                    <div class="menu-item">
                                    ...
                                    <div class="menu-item">
                                        ...
                                        <div class="menu-item">
                                            <a class="menu-link" href="{{ route('admin-donors-list') }}">
                                            <span class="menu-icon">
                                                <!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
                                                <span class="svg-icon svg-icon-2">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                ...
                                                <span class="menu-title">Donors Lists</span>
                                            </a>
                                        </div>

                                        <div class="menu-item">
                                            <a class="menu-link" href="{{ route('admin-city-list') }}">
                                            <span class="menu-icon">
                                                <!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
                                                <span class="svg-icon svg-icon-2">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
...
{{--                                    </div>--}}
                                    <div class="menu-item">
                                        <a class="menu-link" href="{{ url('admin/hospitals-view') }}">
                                        <span class="menu-icon">
                                            <!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
                                            <span class="svg-icon svg-icon-2">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    ...
                                    <div class="menu-item">
                                            <a class="menu-link" href="{{ url('admin/blood-requirement-list') }}">
                                        <span class="menu-icon">
                                            <!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
                                            <span class="svg-icon svg-icon-2">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            ...
                                            <!--end::Svg Icon-->
                                                ...
                                                <span class="menu-title">Blood Requirments </span>
                                                <span class="badge badge-danger">{{getBloodRequirement()}}</span>
                                            </a>
                                        </div>
                                @endif
                            ...
                            @if(isset($hospital_data))

                                <div class="menu-item">
                                    <a class="menu-link" href="{{ url('/users/dashboard/') }}">
                                    <span class="menu-icon">
                                        <!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
                                        <span class="svg-icon svg-icon-2">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                ...
                                <div class="menu-item">
                                    <a class="menu-link" href="{{url('hospital/'.$hospital_data[0]->hospital_id.'/requirement/list')}}">
                                    <span class="menu-icon">
                                        <!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
                                        <span class="svg-icon svg-icon-2">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                ...
                                <div class="d-flex align-items-stretch flex-shrink-0">
                                    ...
                                    <div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px"
                                                    ...
                                                    @if(Session::has('hospital_logged_in'))
                                                        <div class="d-flex flex-column">
                                                            <div class="fw-bolder d-flex align-items-center fs-5">
                                                                {{$hospital_data[0]->hospital_name}}
                                                            </div>
                                                            <a href="#"
                                                               class="fw-bold text-muted text-hover-primary fs-7">
                                                                {{$hospital_data[0]->hospital_id}}
                                                            </a>
                                                        </div>
                                                    @else
                                                    <div class="d-flex flex-column">
                                            ...
                                            <!--begin::Menu item-->
                                            @if(Session::has('hospital_logged_in'))
                                                <a href="{{ url('hospital/profile/'.$hospital_data[0]->hospital_id) }}" class="menu-link px-5">
                                                    Profile
                                                </a>
