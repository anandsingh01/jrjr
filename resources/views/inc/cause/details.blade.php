...
<div class="hs_email field hs-form-field">
    <div class="form-group">
        ...
        <select id="raising_for_someone" required class="form-select nice-select form-select-solid form-select-lg"
                name="raising_for_someone_else">
...
<div class="form-item webform-component webform-component-textfield d-none" id="relation_with_patient" >
    <div class="form-group">
...
<div class="form-item webform-component webform-component-textfield webform-container-inline hs_total_giving_percent_change field hs-form-field" id="webform-component-cultivation--percent-change2">
    ...
    <input type="text" name="city" class="form-control"
           placeholder="Enter Locality" value="">
</div>
