    ...
    <div id="kt_content_container" class="container-xxl">
        <div class="card">
            ...
            <div class="card-body">
                <!--begin::Calendar-->
                <div id="">
                    <form action="{{ route('admin-events-update',['token' => encrypt($event->id)]) }}" method="post"
                            ...
                            <div class="col-sm-6 mb-5">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="event_location" class="form-control"
                                        placeholder="Enter event location" value="{{ $event->location }}">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-6 mb-5">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="event_date" class="form-control"
                                        placeholder="Enter event name" value="{{ $event->event_date }}">
                                </div>
                            </div>
                            <div class="col-sm-6 mb-5">
                                <div class="form-group">
                                    ...
                                    <input type="time" name="event_time" class="form-control"
                                        placeholder="Enter event location" value="{{ $event->event_time }}">
                                </div>
                            </div>
                        </div>
