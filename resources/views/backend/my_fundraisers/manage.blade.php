		...
		<div class="card">
			...
			<div class="card-header">
				<h3 class="card-title align-items-start flex-column">
					<span class="card-label fw-bolder text-dark">My Fundraiser Details </span>
				...
				<h3 class="card-title align-items-start flex-column float-left">
					...
					<a href="{{-- {{url('addmy_fundraiser')}} --}}" class="btn btn-sm btn-primary float-left" id="kt_toolbar_primary_button">Add Blood Donation</a>
							...
							<tr>
								...
								<td>
									<div class="d-flex justify-content-end flex-shrink-0">
										<a href="{{-- {{url('viewmy_fundraiser/'.$row->id)}} --}}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
										...
										<a href="{{-- {{url('editmy_fundraiser/'.$row->id)}} --}}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
										...
										<a href="{{-- {{url('deletemy_fundraiser/'.$row->id)}} --}}" onclick="return myFunction();" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm">
